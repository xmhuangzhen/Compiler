...
for_body_block11; preds = %main_entrance_block_AB_13
    %sum|addr901 = phi i32[ 0, %main_entrance_block_AB_13], [ %ashr144, %if_dest_block15]
    %rng_seed|addr890 = phi i32[ 19260817, %main_entrance_block_AB_13], [ %funccal118, %if_dest_block15]
...
rng_entrance_block_i84; preds = %if_then_block13_AB_55_AB_69_AB_83
    %rng_ip0_218=%funccal112
    %Id_load24_i219 = load i32, i32* %rng_ip0_218
    br label %unsigned_shl_entrance_block_i0_i85

unsigned_shl_entrance_block_i0_i85; preds = %rng_entrance_block_i84
    %unsigned_shl_ip0_0_i220=%Id_load24_i219
    %unsigned_shl_ip1_1_i221=13
    %Id_load1_i2_i222 = load i32, i32* %unsigned_shl_ip0_0_i220
    %Id_load2_i3_i223 = load i32, i32* %unsigned_shl_ip1_1_i221
    shl3_i4_i224 = shl i32 %Id_load1_i2_i222, %Id_load2_i3_i223
    %unsigned_shlreturn_value0_i5_i225=%shl3_i4_i224
...
rng_entrance_block_AB_2_i87; preds = %unsigned_shl_return_block_i1_i86
    %funccal28_i226=%unsigned_shlreturn_value0_i5_i225
    ashr29_i227 = xor i32 %Id_load24_i219, %funccal28_i226
    br label %unsigned_shr_entrance_block_i3_i88

unsigned_shr_entrance_block_i3_i88; preds = %rng_entrance_block_AB_2_i87
    %unsigned_shr_ip0_6_i228=%ashr29_i227
    %unsigned_shr_ip1_7_i229=17
    %Id_load7_i8_i230 = load i32, i32* %unsigned_shr_ip0_6_i228
    %sge8_i9_i231 = icmp sge i32 %Id_load7_i8_i230, 0
    br i1 %sge8_i9_i231, label %if_then_block0_i4_i89, label %if_else_block1_i5_i90

if_then_block0_i4_i89; preds = %unsigned_shr_entrance_block_i3_i88
    %Id_load9_i10_i232 = load i32, i32* %unsigned_shr_ip0_6_i228
    %Id_load10_i11_i233 = load i32, i32* %unsigned_shr_ip1_7_i229
    ashr11_i12_i234 = ashr i32 %Id_load9_i10_i232, %Id_load10_i11_i233
    %unsigned_shrreturn_value4_i13_i235=%ashr11_i12_i234
    br label %unsigned_shr_return_block_i6_i91

if_else_block1_i5_i90; preds = %if_then_block0_i4_i89
    %Id_load12_i14_i236 = load i32, i32* %unsigned_shr_ip1_7_i229
    sub13_i15_i237 = sub i32 31, %Id_load12_i14_i236
    shl14_i16_i238 = shl i32 1, %sub13_i15_i237
    %Id_load15_i17_i239 = load i32, i32* %unsigned_shr_ip0_6_i228
    ashr17_i18_i240 = xor i32 %Id_load15_i17_i239, 2147483648
    %Id_load18_i19_i241 = load i32, i32* %unsigned_shr_ip1_7_i229
    ashr19_i20_i242 = ashr i32 %ashr17_i18_i240, %Id_load18_i19_i241
    or20_i21_i243 = or i32 %shl14_i16_i238, %ashr19_i20_i242
    %unsigned_shrreturn_value4_i13_i235=%or20_i21_i243
    br label %unsigned_shr_return_block_i6_i91
...
rng_entrance_block_AB_2_AB_7_i92; preds = %unsigned_shr_return_block_i6_i91
    %funccal33_i244=%unsigned_shrreturn_value4_i13_i235
    ashr34_i245 = xor i32 %ashr29_i227, %funccal33_i244
    br label %unsigned_shl_entrance_block_i8_i93

unsigned_shl_entrance_block_i8_i93; preds = %rng_entrance_block_AB_2_AB_7_i92
    %unsigned_shl_ip0_22_i246=%ashr34_i245
    %unsigned_shl_ip1_23_i247=5
    %Id_load1_i24_i248 = load i32, i32* %unsigned_shl_ip0_22_i246
    %Id_load2_i25_i249 = load i32, i32* %unsigned_shl_ip1_23_i247
    shl3_i26_i250 = shl i32 %Id_load1_i24_i248, %Id_load2_i25_i249
    %unsigned_shlreturn_value0_i27_i251=%shl3_i26_i250
...
rng_entrance_block_AB_2_AB_7_AB_10_i95; preds = %unsigned_shl_return_block_i9_i94
    %funccal38_i252=%unsigned_shlreturn_value0_i27_i251
    ashr39_i253 = xor i32 %ashr34_i245, %funccal38_i252
    and43_i254 = and i32 %ashr39_i253, 1073741823
    %rngreturn_value21_i255=%and43_i254
...
if_then_block13_AB_55_AB_69_AB_83_AB_97; preds = %rng_return_block_i96
    %funccal115=%rngreturn_value21_i255
    br label %rng_entrance_block_i98

rng_entrance_block_i98; preds = %if_then_block13_AB_55_AB_69_AB_83_AB_97
    %rng_ip0_256=%funccal115
    %Id_load24_i257 = load i32, i32* %rng_ip0_256
    br label %unsigned_shl_entrance_block_i0_i99

unsigned_shl_entrance_block_i0_i99; preds = %rng_entrance_block_i98
    %unsigned_shl_ip0_0_i258=%Id_load24_i257
    %unsigned_shl_ip1_1_i259=13
    %Id_load1_i2_i260 = load i32, i32* %unsigned_shl_ip0_0_i258
    %Id_load2_i3_i261 = load i32, i32* %unsigned_shl_ip1_1_i259
    shl3_i4_i262 = shl i32 %Id_load1_i2_i260, %Id_load2_i3_i261
    %unsigned_shlreturn_value0_i5_i263=%shl3_i4_i262
...
rng_entrance_block_AB_2_i101; preds = %unsigned_shl_return_block_i1_i100
    %funccal28_i264=%unsigned_shlreturn_value0_i5_i263
    ashr29_i265 = xor i32 %Id_load24_i257, %funccal28_i264
    br label %unsigned_shr_entrance_block_i3_i102

unsigned_shr_entrance_block_i3_i102; preds = %rng_entrance_block_AB_2_i101
    %unsigned_shr_ip0_6_i266=%ashr29_i265
    %unsigned_shr_ip1_7_i267=17
    %Id_load7_i8_i268 = load i32, i32* %unsigned_shr_ip0_6_i266
    %sge8_i9_i269 = icmp sge i32 %Id_load7_i8_i268, 0
    br i1 %sge8_i9_i269, label %if_then_block0_i4_i103, label %if_else_block1_i5_i104

if_then_block0_i4_i103; preds = %unsigned_shr_entrance_block_i3_i102
    %Id_load9_i10_i270 = load i32, i32* %unsigned_shr_ip0_6_i266
    %Id_load10_i11_i271 = load i32, i32* %unsigned_shr_ip1_7_i267
    ashr11_i12_i272 = ashr i32 %Id_load9_i10_i270, %Id_load10_i11_i271
    %unsigned_shrreturn_value4_i13_i273=%ashr11_i12_i272
    br label %unsigned_shr_return_block_i6_i105

if_else_block1_i5_i104; preds = %if_then_block0_i4_i103
    %Id_load12_i14_i274 = load i32, i32* %unsigned_shr_ip1_7_i267
    sub13_i15_i275 = sub i32 31, %Id_load12_i14_i274
    shl14_i16_i276 = shl i32 1, %sub13_i15_i275
    %Id_load15_i17_i277 = load i32, i32* %unsigned_shr_ip0_6_i266
    ashr17_i18_i278 = xor i32 %Id_load15_i17_i277, 2147483648
    %Id_load18_i19_i279 = load i32, i32* %unsigned_shr_ip1_7_i267
    ashr19_i20_i280 = ashr i32 %ashr17_i18_i278, %Id_load18_i19_i279
    or20_i21_i281 = or i32 %shl14_i16_i276, %ashr19_i20_i280
    %unsigned_shrreturn_value4_i13_i273=%or20_i21_i281
    br label %unsigned_shr_return_block_i6_i105
...
rng_entrance_block_AB_2_AB_7_i106; preds = %unsigned_shr_return_block_i6_i105
    %funccal33_i282=%unsigned_shrreturn_value4_i13_i273
    ashr34_i283 = xor i32 %ashr29_i265, %funccal33_i282
    br label %unsigned_shl_entrance_block_i8_i107

unsigned_shl_entrance_block_i8_i107; preds = %rng_entrance_block_AB_2_AB_7_i106
    %unsigned_shl_ip0_22_i284=%ashr34_i283
    %unsigned_shl_ip1_23_i285=5
    %Id_load1_i24_i286 = load i32, i32* %unsigned_shl_ip0_22_i284
    %Id_load2_i25_i287 = load i32, i32* %unsigned_shl_ip1_23_i285
    shl3_i26_i288 = shl i32 %Id_load1_i24_i286, %Id_load2_i25_i287
    %unsigned_shlreturn_value0_i27_i289=%shl3_i26_i288
...
rng_entrance_block_AB_2_AB_7_AB_10_i109; preds = %unsigned_shl_return_block_i9_i108
    %funccal38_i290=%unsigned_shlreturn_value0_i27_i289
    ashr39_i291 = xor i32 %ashr34_i283, %funccal38_i290
    and43_i292 = and i32 %ashr39_i291, 1073741823
    %rngreturn_value21_i293=%and43_i292
...
if_then_block13_AB_55_AB_69_AB_83_AB_97_AB_111; preds = %rng_return_block_i110
    %funccal118=%rngreturn_value21_i293

...
main_entrance_block    %call_init1 = call void @__init__()
    ...
    %getElementPtr8 = getelementptr i32, i32* %Id_Load7, i32 0
    store i32 100, i32* %getElementPtr8
    %Id_Load9 = load i32*, i32** %a2
    %getElementPtr10 = getelementptr i32, i32* %Id_Load9, i32 0
    %value11 = load i32, i32* %getElementPtr10
